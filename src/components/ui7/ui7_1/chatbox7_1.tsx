  ...
  return (
    ...
    >
      <div className="relative w-80 py-8 px-10 border-2 border-gray-500 rounded-lg  bg-white text-sm flex flex-col gap-5">
        ...
        <div>
          <p className="break-words text-black font-medium text-base">
            {/* Need support?<br/>
        ...
        <div className="w-full">
          <div className="flex justify-center">
            <div className="bg-brandBoxBgPrimary w-full px-6 py-2 rounded-xl relative  flex flex-row justify-center items-center gap-3">
