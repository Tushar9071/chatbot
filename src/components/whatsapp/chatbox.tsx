...
const Chatbox = () => {
  return (
    <div
      className={`fixed sm:bottom-[70px] sm:right-6 z-50 sm:h-auto sm:w-auto h-screen w-screen rounded-2xl border-secondary border overflow-hidden`}
    >
      <nav className="flex items-center px-5 py-3 bg-[#034737]">
        <button
        ...
        >
          ...
          <img
            ...
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmn4pWrDE1f07NiO_-ALAPW18mUchf6vj9oA&s"
            alt="Image"
          />
        </button>
      ...
      <div className=" w-full chatbox py-4">
